...
static Key keys[] = {
	...
	{ MODKEY|ShiftMask,		XK_m,		spawn,		SHCMD("pactl set-source-mute 0 toggle; kill -44 $(pidof dwmblocks)") },
	...
	{ MODKEY,			XK_F1,		spawn,		SHCMD("groff -mom ~/.local/src/dwm-luke/larbs.mom -Tpdf | zathura -") },
